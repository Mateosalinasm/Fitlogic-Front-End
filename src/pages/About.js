    ...
    return (
        <div className="about-page-container">
            ...
            <div className="about-page">
                ...
                <p>
                    <span className="welcome-about">Welcome to Fitlogic</span>, the health and fitness app that helps you live a healthier lifestyle through diet and exercise. Our app provides you with the necessary tools to achieve your fitness goals and improve your overall well-being.<br/><br/>
